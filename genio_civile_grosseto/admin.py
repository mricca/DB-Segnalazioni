...
def export_pdf_single(modeladmin, request, queryset, cod = None):
    ...
    response['Content-Disposition'] = 'attachment; filename="Studi_Intervento_Grosseto.pdf"'
    ...
    header = Paragraph('''<para align=center spaceb=3><b><font color=red >Studi e Interventi Grosseto</font></b></para>''', style)
...
def export_csv(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_grosseto.csv'
...
def export_xls(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_grosseto.xls'
...
class InterventoAdmin(GeoModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            #codice_intervento = 'DA' + str(current_year) + 'GR' + '0001'
            #codice_intervento = 'DA' + '2014' + 'GR' + '0001'
            codice_intervento = 'DODS-' + 'GR' + '0001'
            ...
            if codLen == 12:
                codice_intervento = 'DA' + '2014' + 'GR' + ultimo[0]
            else:
                codice_intervento = 'DODS-' + 'GR' + ultimo[0]
