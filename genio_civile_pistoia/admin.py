...
def export_pdf_single(modeladmin, request, queryset, cod = None):
    ...
    response['Content-Disposition'] = 'attachment; filename="Studi_Intervento_Pistoia.pdf"'
    ...
    header = Paragraph('''<para align=center spaceb=3><b><font color=red >Studi e Interventi Pistoia</font></b></para>''', style)
...
def export_csv(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_pistoia.csv'
...
def export_xls(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_pistoia.xls'
...
class InterventoAdmin(GeoModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            #codice_intervento = 'DA' + str(current_year) + 'PT' + '0001'
            #codice_intervento = 'DA' + '2014' + 'PT' + '0001'
            codice_intervento = 'DODS-' + 'PT' + '0001'
            ...
            if codLen == 12:
                codice_intervento = 'DA' + '2014' + 'PT' + ultimo[0]
            else:
                codice_intervento = 'DODS-' + 'PT' + ultimo[0]
