...
def export_csv(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_livorno.csv'
...
class InterventoAdmin(GeoModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            #codice_intervento = 'DA' + str(current_year) + 'LI' + '0001'
            #codice_intervento = 'DA' + '2014' + 'LI' + '0001'
            codice_intervento = 'DODS-' + 'LI' + '0001'
            ...
            if codLen == 12:
                ...
                codice_intervento = 'DODS-' + 'LI' + ultimo[0]
