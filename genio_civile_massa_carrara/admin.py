...
def export_pdf_single(modeladmin, request, queryset, cod = None):
    ...
    response['Content-Disposition'] = 'attachment; filename="Studi_Intervento_Massa-Carrara.pdf"'
    ...
    header = Paragraph('''<para align=center spaceb=3><b><font color=red >Studi e Interventi Massa-Carrara</font></b></para>''', style)
    ...
    for obj in queryset:
        if obj.codice_intervento == cod:
            allproducts.append([smart_str(u"codice_intervento"),Paragraph(smart_str(obj.codice_intervento),style)])
            allproducts.append([smart_str(u"bacino_idrografico"),Paragraph(smart_str(obj.bacino_idrografico),style)])
            allproducts.append([smart_str(u"comprensorio"),Paragraph(smart_str(obj.comprensorio),style)])
            ...
            allproducts.append([smart_str(u"corso_acqua"),Paragraph(smart_str(obj.corso_acqua),style)])
            allproducts.append([smart_str(u"reticolo_gestione"),Paragraph(smart_str(obj.reticolo_gestione),style)])
            allproducts.append([smart_str(u"geometria"),Paragraph(smart_str(obj.fenomeno_aggiunto),style)])
            allproducts.append([smart_str(u"fenomeno"),Paragraph(smart_str(obj.fenomeno),style)])
            allproducts.append([smart_str(u"studio_intervento"),Paragraph(smart_str(obj.studio_intervento),style)])
            allproducts.append([smart_str(u"tipologia_intervento"),Paragraph(smart_str(obj.tipologia_intervento),style)])
            allproducts.append([smart_str(u"tipo_di_opera"),Paragraph(smart_str(obj.tipo_di_opera),style)])
            allproducts.append([smart_str(u"cat_int"),Paragraph(smart_str(obj.cat_int),style)])
            allproducts.append([smart_str(u"area_vasta_rif"),Paragraph(smart_str(obj.area_vasta_rif),style)])
            allproducts.append([smart_str(u"titolo_intervento_studio"),Paragraph(smart_str(obj.titolo_intervento_studio),style)])
            allproducts.append([smart_str(u"descrizione_sintetica_intervento_studio"),Paragraph(smart_str(obj.descrizione_sintetica_intervento_studio),style)])
            allproducts.append([smart_str(u"categoria_idr_opera"),Paragraph(smart_str(obj.categoria_idr_opera),style)])
            allproducts.append([smart_str(u"perimetrazione_autorita_di_bacino"),Paragraph(smart_str(obj.perimetrazione_autorita_di_bacino),style)])
            allproducts.append([smart_str(u"Classe pericolosita PAI o PGRA"),Paragraph(smart_str(obj.codice_pericolosita_adb_pai),style)])
            allproducts.append([smart_str(u"Classe rischio PAI o PGRA"),Paragraph(smart_str(obj.classe_rischio_pai),style)])
            allproducts.append([smart_str(u"stima_rischio_diretto_attuale"),Paragraph(smart_str(obj.stima_rischio_diretto_attuale),style)])
            allproducts.append([smart_str(u"stima_rischio_indiretto_attuale"),Paragraph(smart_str(obj.stima_rischio_indiretto_attuale),style)])
            allproducts.append([smart_str(u"stima_rischio_diretto_intervento"),Paragraph(smart_str(obj.stima_rischio_diretto_intervento),style)])
            allproducts.append([smart_str(u"stima_rischio_indiretto_intervento"),Paragraph(smart_str(obj.stima_rischio_indiretto_intervento),style)])
            allproducts.append([smart_str(u"ente_proponente"),Paragraph(smart_str(obj.ente_proponente),style)])
            allproducts.append([smart_str(u"ente_attuatore_competente"),Paragraph(smart_str(obj.ente_attuatore_competente),style)])
            allproducts.append([smart_str(u"nominativo"),Paragraph(smart_str(obj.nominativo),style)])
            allproducts.append([smart_str(u"email"),Paragraph(smart_str(obj.email),style)])
            allproducts.append([smart_str(u"recapito_telefonico"),Paragraph(smart_str(obj.recapito_telefonico),style)])            
            allproducts.append([smart_str(u"interventi_correlati"),Paragraph(smart_str(obj.interventi_correlati),style)])
            allproducts.append([smart_str(u"stralcio_funzionale"),Paragraph(smart_str(obj.stralcio_funzionale),style)])
            allproducts.append([smart_str(u"accordo_di_programma"),Paragraph(smart_str(obj.accordo_di_programma),style)])
            allproducts.append([smart_str(u"note"),Paragraph(smart_str(obj.note),style)])
            allproducts.append([smart_str(u"progetto_preliminare"),Paragraph(smart_str(obj.progetto_preliminare),style)])
            allproducts.append([smart_str(u"mesi_approvazione_progetto_preliminare"),Paragraph(smart_str(obj.mesi_approvazione_progetto_preliminare),style)])
            allproducts.append([smart_str(u"data_approvazione_progetto_preliminare"),Paragraph(smart_str(obj.data_approvazione_progetto_preliminare),style)])
            allproducts.append([smart_str(u"riferimento_determina_approvazione_pp"),Paragraph(smart_str(obj.riferimento_determina_approvazione_pp),style)])
            allproducts.append([smart_str(u"allegato_determina_approvazione_pp"),Paragraph(smart_str(obj.allegato_determina_approvazione_pp),style)])
            allproducts.append([smart_str(u"progetto_definitivo"),Paragraph(smart_str(obj.progetto_definitivo),style)])
            allproducts.append([smart_str(u"mesi_approvazione_progetto_definitivo"),Paragraph(smart_str(obj.mesi_approvazione_progetto_definitivo),style)])
            allproducts.append([smart_str(u"data_approvazione_progetto_definitivo"),Paragraph(smart_str(obj.data_approvazione_progetto_definitivo),style)])
            allproducts.append([smart_str(u"riferimento_determina_approvazione_pd"),Paragraph(smart_str(obj.riferimento_determina_approvazione_pd),style)])
            allproducts.append([smart_str(u"allegato_determina_approvazione_pd"),Paragraph(smart_str(obj.allegato_determina_approvazione_pd),style)])
            allproducts.append([smart_str(u"mesi_approvazione_progetto_esecutivo"),Paragraph(smart_str(obj.mesi_approvazione_progetto_esecutivo),style)])
            allproducts.append([smart_str(u"data_approvazione_progetto_esecutivo"),Paragraph(smart_str(obj.data_approvazione_progetto_esecutivo),style)])
            allproducts.append([smart_str(u"riferimento_determina_approvazione_pe"),Paragraph(smart_str(obj.riferimento_determina_approvazione_pe),style)])
            allproducts.append([smart_str(u"allegato_determina_approvazione_pe"),Paragraph(smart_str(obj.allegato_determina_approvazione_pe),style)])
            allproducts.append([smart_str(u"mesi_inizio_lavori"),Paragraph(smart_str(obj.mesi_inizio_lavori),style)])
            allproducts.append([smart_str(u"inizio_lavori"),Paragraph(smart_str(obj.inizio_lavori),style)])
            allproducts.append([smart_str(u"mesi_fine_lavori"),Paragraph(smart_str(obj.mesi_fine_lavori),style)])
            allproducts.append([smart_str(u"fine_lavori"),Paragraph(smart_str(obj.fine_lavori),style)])
            allproducts.append([smart_str(u"elaborati_progettuali"),Paragraph(smart_str(obj.elaborati_progettuali),style)])
            allproducts.append([smart_str(u"allegato_documento_preliminare"),Paragraph(smart_str(obj.allegato_documento_preliminare),style)])
            allproducts.append([smart_str(u"conclusione_relazione_finale"),Paragraph(smart_str(obj.conclusione_relazione_finale),style)])
            allproducts.append([smart_str(u"mesi_conclusione_relazione_finale"),Paragraph(smart_str(obj.mesi_conclusione_relazione_finale),style)])
            allproducts.append([smart_str(u"elenco_pareri"),Paragraph(smart_str(obj.elenco_pareri),style)])
            allproducts.append([smart_str(u"atto_valutazione"),Paragraph(smart_str(obj.atto_valutazione),style)])
            allproducts.append([smart_str(u"allegato_atto_valutazione"),Paragraph(smart_str(obj.allegato_atto_valutazione),style)])
            allproducts.append([smart_str(u"codice_unico_progetto"),Paragraph(smart_str(obj.codice_unico_progetto),style)])
            allproducts.append([smart_str(u"atto_nomina_rup"),Paragraph(smart_str(obj.atto_nomina_rup),style)])
            allproducts.append([smart_str(u"allegato_atto_nomina_rup"),Paragraph(smart_str(obj.allegato_atto_nomina_rup),style)])
            allproducts.append([smart_str(u"intervento_opere_accessorie"),Paragraph(smart_str(obj.intervento_opere_accessorie),style)])
            allproducts.append([smart_str(u"presenza_vincoli_sovraordinati"),Paragraph(smart_str(obj.presenza_vincoli_sovraordinati),style)])
            allproducts.append([smart_str(u"desc_opere_acc_strum"),Paragraph(smart_str(obj.desc_opere_acc_strum),style)])
            allproducts.append([smart_str(u"importo_opere_accessorie_strumentali"),Paragraph(smart_str(obj.importo_opere_accessorie_strumentali),style)])
            allproducts.append([smart_str(u"desc_opere_acc_no_strum"),Paragraph(smart_str(obj.desc_opere_acc_no_strum),style)])
            allproducts.append([smart_str(u"importo_opere_accessorie_no_strumentali"),Paragraph(smart_str(obj.importo_opere_accessorie_no_strumentali),style)])
            allproducts.append([smart_str(u"intervento_opere_mitigazione_compensazione"),Paragraph(smart_str(obj.intervento_opere_mitigazione_compensazione),style)])
            allproducts.append([smart_str(u"desc_int_opere_mitig_comp"),Paragraph(smart_str(obj.desc_int_opere_mitig_comp),style)])
            allproducts.append([smart_str(u"importo_opere_mitig_comp"),Paragraph(smart_str(obj.importo_opere_mitig_comp),style)])
            allproducts.append([smart_str(u"importo_totale_intervento"),Paragraph(smart_str(obj.importo_totale_intervento),style)])
            allproducts.append([smart_str(u"importo_richiesto"),Paragraph(smart_str(obj.importo_richiesto),style)])
            allproducts.append([smart_str(u"importo_cofinanziato_altri"),Paragraph(smart_str(obj.importo_cofinanziato_altri),style)])
            allproducts.append([smart_str(u"ente_cofinanziatore"),Paragraph(smart_str(obj.ente_cofinanziatore),style)])            
            allproducts.append([smart_str(u"efficacia"),Paragraph(smart_str(obj.efficacia),style)])
            allproducts.append([smart_str(u"efficacia_val"),Paragraph(smart_str(obj.efficacia_val),style)])
            allproducts.append([smart_str(u"cantierabilita"),Paragraph(smart_str(obj.cantierabilita),style)])
            allproducts.append([smart_str(u"cantierabilita_val"),Paragraph(smart_str(obj.cantierabilita_val),style)])
            allproducts.append([smart_str(u"variante_urbanistica"),Paragraph(smart_str(obj.variante_urbanistica),style)])
            allproducts.append([smart_str(u"variante_urbanistica_val"),Paragraph(smart_str(obj.variante_urbanistica_val),style)])
            allproducts.append([smart_str(u"valutazione_impatto_ambientale"),Paragraph(smart_str(obj.valutazione_impatto_ambientale),style)])
            allproducts.append([smart_str(u"valutazione_impatto_ambientale_val"),Paragraph(smart_str(obj.valutazione_impatto_ambientale_val),style)])
            allproducts.append([smart_str(u"esproprio"),Paragraph(smart_str(obj.esproprio),style)])
            allproducts.append([smart_str(u"esproprio_val"),Paragraph(smart_str(obj.esproprio_val),style)])
            allproducts.append([smart_str(u"sostenibilita"),Paragraph(smart_str(obj.sostenibilita),style)])
            allproducts.append([smart_str(u"sostenibilita_val"),Paragraph(smart_str(obj.sostenibilita_val),style)])
            allproducts.append([smart_str(u"Punteggio provvisoriamente assegnato"),Paragraph(smart_str(obj.totale),style)])
            allproducts.append([smart_str(u"conclusione_istruttoria"),Paragraph(smart_str(obj.conclusione_istruttoria),style)])
            allproducts.append([smart_str(u"nominativo_compilatore"),Paragraph(smart_str(obj.nominativo_compilatore),style)])
            allproducts.append([smart_str(u"email_comp"),Paragraph(smart_str(obj.email_comp),style)])
            allproducts.append([smart_str(u"Geni_civili_02_2016"),Paragraph(smart_str(obj.nuovi_geni_civili),style)])
            allproducts.append([smart_str(u"priorita"),Paragraph(smart_str(obj.priorita),style)])
            allproducts.append([smart_str(u"codice_rendis"),Paragraph(smart_str(obj.codice_rendis),style)])
            allproducts.append([smart_str(u"data_trasmissione_istruttoria"),Paragraph(smart_str(obj.data_trasmissione_istruttoria),style)])
...
def export_pdf(modeladmin, request, queryset):
    ...
    for obj in queryset:
        ...
        allproducts.append([smart_str(u"Codice intervento"),Paragraph(smart_str(obj.codice_intervento),style)])
        allproducts.append([smart_str(u"Bacino Idrografico"),Paragraph(smart_str(obj.bacino_idrografico),style)])
        allproducts.append([smart_str(u"Comprensorio"),Paragraph(smart_str(obj.comprensorio),style)])
        allproducts.append([smart_str(u"Provincia"),Paragraph(smart_str(obj.provincia),style)])
        allproducts.append([smart_str(u"Comune"),Paragraph(smart_str(obj.comune),style)])
        allproducts.append([smart_str(u"Localita"),Paragraph(smart_str(obj.localita),style)])
        allproducts.append([smart_str(u"Corso acqua"),Paragraph(smart_str(obj.corso_acqua),style)])
        allproducts.append([smart_str(u"Reticolo di gestione"),Paragraph(smart_str(obj.reticolo_gestione),style)])
        allproducts.append([smart_str(u"Geometria"),Paragraph(smart_str(obj.fenomeno_aggiunto),style)])
        allproducts.append([smart_str(u"Fenomeno"),Paragraph(smart_str(obj.fenomeno),style)])
        allproducts.append([smart_str(u"Studio Intervento"),Paragraph(smart_str(obj.studio_intervento),style)])
        allproducts.append([smart_str(u"Tipologia intervento"),Paragraph(smart_str(obj.tipologia_intervento),style)])
        allproducts.append([smart_str(u"Tipo di opera"),Paragraph(smart_str(obj.tipo_di_opera),style)])
        allproducts.append([smart_str(u"Categoria intervento"),Paragraph(smart_str(obj.cat_int),style)])
        allproducts.append([smart_str(u"Area vasta di riferimento"),Paragraph(smart_str(obj.area_vasta_rif),style)])
        allproducts.append([smart_str(u"Titolo Intervento Studio"),Paragraph(smart_str(obj.titolo_intervento_studio),style)])
        allproducts.append([smart_str(u"Descrizione sintetica Intervento Studio"),Paragraph(smart_str(obj.descrizione_sintetica_intervento_studio),style)])
        allproducts.append([smart_str(u"categoria_idr_opera"),Paragraph(smart_str(obj.categoria_idr_opera),style)])
        allproducts.append([smart_str(u"perimetrazione_autorita_di_bacino"),Paragraph(smart_str(obj.perimetrazione_autorita_di_bacino),style)])
        allproducts.append([smart_str(u"Classe pericolosita PAI o PGRA"),Paragraph(smart_str(obj.codice_pericolosita_adb_pai),style)])
        allproducts.append([smart_str(u"Classe rischio PAI o PGRA"),Paragraph(smart_str(obj.classe_rischio_pai),style)])
...
def export_csv(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_massa_carrara.csv'
...
def export_xls(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_massa_carrara.xls'
...
class InterventoAdmin(GeoModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            #codice_intervento = 'DA' + str(current_year) + 'MS' + '0001'
            #codice_intervento = 'DA' + '2014' + 'MS' + '0001'
            codice_intervento = 'DODS-' + 'MS' + '0001'
            ...
            if codLen == 12:
                codice_intervento = 'DA' + '2014' + 'MS' + ultimo[0]
            else:
                codice_intervento = 'DODS-' + 'MS' + ultimo[0]
