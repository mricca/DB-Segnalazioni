...
def export_pdf_single(modeladmin, request, queryset, cod = None):
    ...
    response['Content-Disposition'] = 'attachment; filename="Studi_Intervento_Siena.pdf"'
    ...
    header = Paragraph('''<para align=center spaceb=3><b><font color=red >Studi e Interventi Siena</font></b></para>''', style)
...
def export_csv(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_siena.csv'
...
def export_xls(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_siena.xls'
...
class InterventoAdmin(GeoModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            #codice_intervento = 'DA' + str(current_year) + 'SI' + '0001'
            #codice_intervento = 'DA' + '2014' + 'SI' + '0001'
            codice_intervento = 'DODS-' + 'SI' + '0001'
            ...
            if codLen == 12:
                codice_intervento = 'DA' + '2014' + 'SI' + ultimo[0]
            else:
                codice_intervento = 'DODS-' + 'SI' + ultimo[0]
