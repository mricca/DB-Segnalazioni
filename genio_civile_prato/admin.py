...
def export_pdf_single(modeladmin, request, queryset, cod = None):
    ...
    response['Content-Disposition'] = 'attachment; filename="Studi_Intervento_Prato.pdf"'
    ...
    header = Paragraph('''<para align=center spaceb=3><b><font color=red >Studi e Interventi Prato</font></b></para>''', style)
...
def export_csv(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_prato.csv'
...
def export_xls(modeladmin, request, queryset):
    ...
    response['Content-Disposition'] = 'attachment; filename=studi_interventi_prato.xls'
...
class InterventoAdmin(GeoModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            #codice_intervento = 'DA' + str(current_year) + 'PO' + '0001'
            #codice_intervento = 'DA' + '2014' + 'PO' + '0001'
            codice_intervento = 'DODS-' + 'PO' + '0001'
            ...
            if codLen == 12:
                codice_intervento = 'DA' + '2014' + 'PO' + ultimo[0]
            else:
                codice_intervento = 'DODS-' + 'PO' + ultimo[0]
